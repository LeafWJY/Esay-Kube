...
//  Easy Kube
//
//  Created by 王镓耀 on 2020/9/7.
//  Copyright © 2020 codewjy. All rights reserved.
//

import SwiftUI

public struct PullRefresh: UIViewRepresentable {
    ...
    public func makeUIView(context: UIViewRepresentableContext<PullRefresh>) -> UIView {
    ...
    public func updateUIView(_ uiView: UIView, context: UIViewRepresentableContext<PullRefresh>) {
